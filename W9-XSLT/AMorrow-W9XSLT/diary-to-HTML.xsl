...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="d:p"> <!-- Match <entry>, surround each one with an HTML <p> element, show paragraph number in brackets, and keep going  -->
    ...
    <xsl:template match="d:q"> <!-- Match q element and put in quotations -->
        "<xsl:apply-templates/>"
    </xsl:template>
