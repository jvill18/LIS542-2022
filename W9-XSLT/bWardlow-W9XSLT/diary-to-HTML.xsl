...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <html>
            ...
            <body>
                ...
                <div>
                    ...
                    <p>
                        <ol>
                            <xsl:for-each select="//d:entries//d:name"> <xsl:value-of select="@role"/>
                                <li>
    ...
    <xsl:template match="d:p"> [<xsl:value-of select="@n"/>] <!-- Match <entry>, surround each one with an HTML <p> element and keep going  -->
        <p>
            <xsl:apply-templates/>
        </p>
    </xsl:template>
    ...
    <xsl:template match="d:cite">
        <a href="VALUE"><xsl:value-of select="@ref"/></a><xsl:apply-templates></xsl:apply-templates>
    </xsl:template>
