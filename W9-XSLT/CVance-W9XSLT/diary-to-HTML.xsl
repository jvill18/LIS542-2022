...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                    ...
                    <p>
                        <ol>
                            <xsl:for-each select="//d:entries//d:place">
                                <li>
                                    <xsl:value-of select="."/>  <!-- the . here means to use the
                                        content of the selected element; in this case, <place> -->
                                </li>
                            </xsl:for-each>
                        </ol>
                    </p>
    ...
    <xsl:template match="d:cite">
        <a href="@ref">https://www.kingjamesbibleonline.org <xsl:apply-templates/> </a>
    </xsl:template>
